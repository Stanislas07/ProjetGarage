...
<body>
    <header>
        <div class="nav container">
            ...
            <a href="deconnexion.php" class="login">Se déconnecter</a>
        </div>
    </header>
    <!-- Selection de voitures -->
    <section class="cars" id="cars">
        <div class="heading">
            <span>Catalogue des voitures</span>
            <h2>Gestion des voitures</h2>
            <p>Vous pourrez ici modifier, supprimer et ajouter des véhicules.</p>
        </div>

<!-- Filtre -->
<div class="filtre">
    <h1><i class='bx bx-menu' id="menu-icon"></i>  Filtre</h1>
